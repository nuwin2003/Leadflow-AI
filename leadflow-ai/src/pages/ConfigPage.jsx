...
function SecretField({ label, id, defaultValue, placeholder }) {
...
function TagInput({ label, initial }) {
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="card">
            ...
            <TagInput
              ...
              initial={['SaaS', 'FinTech', 'HealthTech']}
            />
            <TagInput
              label="Geography (ISO codes)"
              initial={['US', 'GB', 'CA', 'AU']}
            />
            ...
            <div className="mb-3">
              <label className="form-label" htmlFor="template-id">Email Template ID</label>
              <input
                id="template-id"
                className="form-input"
            ...
            <div className="mb-3">
              ...
              <div className="flex items-center gap-3">
                <input
                  id="conf-threshold"
                  type="range" min={50} max={100} defaultValue={80}
                  className="flex-1"
                />
